<template>
  ...
  <el-form ref="ruleForm" :model="commodityclassification" label-width="100px">
    <input v-model="commodityclassification.ccid" type="hidden">
    <el-form-item label="活动名称">
      <el-input v-model="commodityclassification.ccname" />
    </el-form-item>
    <el-form-item>
