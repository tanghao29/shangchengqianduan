<template>
  <div>
    <el-table :data="tableData.slice((currpage - 1) * pagesize, currpage * pagesize)" border style="width: 100%">
      ...
      <el-table-column prop="ccname" property="ccname" label="参数" />
      <el-table-column prop="cenumber" property="cenumber" label="库存数量" />
      <el-table-column prop="cebuymoney" property="cebuymoney" label="进价" />
      <el-table-column prop="cesellmoney" property="cesellmoney" label="售价" />
      ...
      <el-table-column prop="cstate" property="cstate" label="状态">
        <template slot-scope="scope">
          <el-switch active-color="#13ce66" inactive-color="#ff4949" active-text="上架" inactive-text="下架" active-value="1" inactive-value="2" @change="change(scope.row)" />
        </template>
      </el-table-column>
